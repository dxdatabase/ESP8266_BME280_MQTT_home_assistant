...
## French
Petit script Arduino pour ESP8266 Aliexpress équipé d'un écran OLED. Récupère la température, l'humidité et la pression sur un module capteur BME280. Affiche la température et l'humidité en haut de l'écran de l'ESP, et l'heure en bas. Envoi par le wifi la température, l'humidité et la pression via MQTT afin de s'interfacer avec Home Assistant (ou tout système compatible MQTT). Licence : faites ce que vous voulez !
